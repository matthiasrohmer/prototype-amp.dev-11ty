...
Want to learn more about Glitch? You can read about it in the [appendix]({{g.doc('/amp-dev/documentation/courses/beginning-course/appendix.md', locale=doc.locale).url.path}}).
